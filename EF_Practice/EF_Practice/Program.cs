...
namespace EF_Practice
{
    class Program
    {
        ...
        {
            return ((xx >= 0 && xx < 500 && yy >= 0 && yy < 500) ? Category.ThirdQ : (xx > 500 && xx <= 1000 && yy >= 0 && yy < 500) ? Category.FourthQ : (xx > 500 && xx <= 1000 && yy > 500 && yy <= 1000) ? Category.FirstQ : (xx >= 0 && xx < 500 && yy > 500 && yy <= 1000) ? Category.SecondQ : Category.ZeroP);
        }
        ...
        static void Main(string[] args)
        {
            ...
            var zp = new Point { Id = 999, X = 500, Y = 500, Group = SetGroup(500, 500), Category = SetCategory(500, 500) };
